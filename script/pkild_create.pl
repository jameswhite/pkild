...
pod2usage(1) unless $helper->mk_component( 'pkild', @ARGV );
...
pkild_create.pl [options] model|view|controller name [helper] [options]
 ...
 Examples:
   ...
   pkild_create.pl controller My::Controller BindLex
   pkild_create.pl -mechanize controller My::Controller
   pkild_create.pl view My::View
   pkild_create.pl view MyView TT
   pkild_create.pl view TT TT
